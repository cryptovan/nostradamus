...
import { Layout, Menu, Table, Badge, Breadcrumb, Dropdown, Icon, Spin, notification } from 'antd'
    ...
    render() {
        ...
        return (
            <BasicLayout className="Page">
                ...
                <Content className="trends" style={{ padding: 10, margin: 0 }}>
                    <h2>Trends</h2>
                    <br />
                    ...
                    <br />
                    <iframe src="https://bittrex.com/Home/Markets" width="500" height="500" ref={(ref) => this.marketFrameRef = ref}></iframe>
                </Content>
            </BasicLayout>
        )
    }
...
Container.displayName = 'trends/Container'
